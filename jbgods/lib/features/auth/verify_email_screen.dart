...
//       // Get fresh user data from Firebase with retry logic
//       int retryCount = 0;
...
//         if (!isVerified) {
//           print('Attempt ${retryCount + 1}: User email verified: $isVerified');
//           await Future.delayed(const Duration(seconds: 1));
//           retryCount++;
//         }
//       }
      
//       print('Final verification status: $isVerified');
...
//         // If email is verified, cancel timer and navigate to login
//         if (isVerified) {
//           _timer?.cancel();
//           if (mounted) {
...
//               const SnackBar(
//                 content: Text('✅ Email verified successfully! Please login again.'),
